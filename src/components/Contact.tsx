...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "kishanshiyal9988@gmail.com", href: "mailto:kishanshiyal9988@gmail .com" },
    { icon: Phone, label: "Phone", value: "+91 8154001567", href: "tel:+918154001567" },
