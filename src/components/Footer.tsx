        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary to-purple-500 flex items-center justify-center">
              <span className="font-display font-bold text-primary-foreground text-lg">KN</span>
            </div>
            <span className="font-display font-semibold text-lg text-foreground">Kishan Shiyal</span>
          </div>

          {/* Social Links */}
          <div className="flex gap-4">
            {[
              { icon: Github, href: "https://github.com/kishanshiyal", label: "GitHub" },
              { icon: Linkedin, href: "https://linkedin.com/in/kishan-shiyal-6a4065340", label: "LinkedIn" },
            ].map((social, idx) => (
              <a
                key={idx}
                href={social.href}
          ...
          © {currentYear} Made by Kishan Shiyal
          </p>
        </div>
      </div>
    </footer>
