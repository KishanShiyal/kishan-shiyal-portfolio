            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative mb-6">
                <div className="w-48 h-48 rounded-2xl overflow-hidden border-2 border-primary/30 glow-effect">
                  <img
                    src="kishan.jpg"
                    alt="Kishan Shiyal - Full Stack Developer"
              ...
              <div className="w-full glass-card p-4 mb-6 space-y-3">
                <div className="flex items-center gap-3 text-muted-foreground">
                  ...
                  <a href="tel:+918154001567" className="hover:text-primary transition-colors text-sm">
                    +91 8154001567
                  </a>
                </div>
                <div className="flex items-center gap-3 text-muted-foreground">
                  <Mail className="w-4 h-4 text-primary" />
                  <a href="mailto:kishanshiyak9988@gmail.com" className="hover:text-primary transition-colors text-sm">
                    kishanshiyal9988@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 w-full mb-6">
                ...
                <a href="/Kishan_Shiyal.pdf" target="_blank" rel="noopener noreferrer">
              ...
              <div className="flex gap-4">
                {[
                  { icon: Github, href: "https://github.com/kishanshiyal" },
                  { icon: Linkedin, href: "https://www.linkedin.com/in/kishan-shiyal-6a4065340" },
                ].map((social, idx) => (
                  <a
                    key={idx}
                    href={social.href}
